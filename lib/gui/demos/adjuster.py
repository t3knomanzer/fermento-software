...
from lib.gui.widgets import Label, CloseButton, Adjuster, FloatAdj
...
class BaseScreen(Screen):
    def __init__(self):
        ...
        a = Adjuster(
            wri, row, self.lbl1.mcol + 2, fgcolor=RED, callback=self.adj1_callback
        )
        ...
        a = Adjuster(
            wri, row, self.lbl3.mcol + 2, fgcolor=YELLOW, callback=self.adj3_callback
        )
